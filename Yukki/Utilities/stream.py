...
async def start_stream(
    ...
    if await is_active_chat(CallbackQuery.message.chat.id):
        ...
        final_output = await CallbackQuery.message.reply_photo(
            photo=thumb,
            caption=(
                f"🎬<b>__Âm Nhạc:__ </b>[{title[:25]}](https://www.youtube.com/watch?v={videoid}) \n⏳<b>__Thời Lượng:__</b> {duration_min} \n💡<b>__Thông Tin:__</b> [Nhận thông tin bổ sung](https://t.me/{BOT_USERNAME}?start=info_{videoid})\n👤<b>__Yêu Cầu Bởi:__ </b>{CallbackQuery.from_user.mention} \n🚧<b>__Hàng Đợi:__</b> <b>#{position}!</b>"
            ),
        ...
        await mystic.delete()
        cap = f"🎥<b>__Đang Phát:__ </b>[{title[:25]}](https://www.youtube.com/watch?v={videoid}) \n💡<b>__Thông Tin:__</b> [Nhận thông tin bổ sung](https://t.me/{BOT_USERNAME}?start=info_{videoid})\n👤**__Yêu Cầu Bởi:__** {CallbackQuery.from_user.mention}"
        final_output = await CallbackQuery.message.reply_photo(
            photo=thumb,
            reply_markup=InlineKeyboardMarkup(buttons),
            caption=cap,
...
async def start_stream_audio(
    ...
    if await is_active_chat(message.chat.id):
        ...
        final_output = await message.reply_photo(
            ...
            caption=(
                f"🎬<b>__Âm thanh:__ </b> [Given Audio Via Telegram]({link})\n⏳<b>__Thời Lượng:__</b> {duration_min} \n👤<b>__Yêu Cầu Bởi:__ </b>{message.from_user.mention} \n🚧<b>__Hàng Đợi:__</b> <b>#{position}!</b>"
            ),
        ...
        await mystic.delete()
        cap = f"🎥<b>__Đang Phát:__ </b>[Cho âm thanh qua Telegram]({link})\n👤**__Được yêu cầu bởi:__** {message.from_user.mention}"
        final_output = await message.reply_photo(
            photo="Utils/Telegram.JPEG",
            reply_markup=InlineKeyboardMarkup(buttons),
            caption=cap,
